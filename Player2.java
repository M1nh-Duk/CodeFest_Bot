...
public class Player2 {
    ...
    final static String GAME_ID = "83b2a3a1-53fc-4288-b128-05c099ac413b";
    ...
    public static void dodge_infected_human (int [][] map_coordinate,Hero player1, MapInfo map, Position currentPosition, int current_row, int current_col){
        if (map.getDhuman().size() == 0);
            ...
            jsclub.codefest.sdk.socket.data.Player player_info = map.getPlayerByKey("player2-xxx");
...
//
//            }
            if (path.length()>2) player1.move(path.substring(0,2));
